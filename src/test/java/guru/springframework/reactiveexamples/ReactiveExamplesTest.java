...
public class ReactiveExamplesTest {
  ...
  private Person fiona = new Person("Fiona", "Glenann");
  ...
  public void fluxTestDelay() throws Exception {
    ...
    people.delayElements(Duration.ofSeconds(1))
        ...
        .subscribe(person -> log.info("first stream {}", person.sayMyName()));

    people.delayElements(Duration.ofSeconds(1))
        .doOnComplete(countDownLatch::countDown)
        .subscribe(person -> log.info("second stream {}", person.sayMyName()));
